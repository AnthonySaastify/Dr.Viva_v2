        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="font-medium text-slate-900 dark:text-white text-lg">Dr. AIVA</span>
            </Link>
            ...
            <div className="hidden md:flex items-center space-x-1">
              ...
              <Button variant="ghost" size="sm" className="font-medium" asChild>
                <Link href="/track-plan">Track & Plan</Link>
              </Button>
              <Button variant="ghost" size="sm" className="font-medium" asChild>
                <Link href="/learn-space">Learn Space</Link>
              </Button>
              <Button variant="ghost" size="sm" className="font-medium" asChild>
                <Link href="/curriculum-hub">Curriculum Hub</Link>
              </Button>
              <Button variant="ghost" size="sm" className="font-medium" asChild>
                <Link href="/mind-boost">Language</Link>
              </Button>
              <Button variant="ghost" size="sm" className="font-medium" asChild>
                <Link href="/next-step">Next Step</Link>
              </Button>
            </div>
